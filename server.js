...
const bodyParser = require("body-parser"); //biblioteka i kuria kreipiamasi. Reikia tiesiog zinoti :D
...
app.use(bodyParser.urlencoded({ extended: true })); //logikos neieskoti, taip suprogramuota, tiesiog reikia rasyti :D
...
app.post("/update/:id", (req, res) => {
  ...
  if (!oldBook) {
    console.log('testuotojai patenka čia');//užduotis testuotojamas
    show404(res);
    return;
  }
